...
- Copy the code for three ggplot(ly) objects into the r chunks
- "knit" the file -> choose "Knit to html"
- Open in browser
...
- We want 4 figures for this exercise so either 
    - create a new figure
    - copy the code from an existing figure (duplicate)
...
## Advanced exercises
Repeat intermeidate exercises but with your data - we're here to help
