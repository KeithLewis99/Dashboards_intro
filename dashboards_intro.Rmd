...
- We want 4 figures for this exercize so either 
    - create a new figure
    - copy the code from an existing figure
- Add a page and add the fourth graph
- On one page, tabset the figures
- On the other page, create a dropdown menu 
